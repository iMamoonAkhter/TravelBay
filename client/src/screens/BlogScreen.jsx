...
const BlogScreen = () => {
  ...
  return <VStack spacing='30px' minHeight='100vh'>
        <Heading fontSize='5x1' mb='16'>
            {pageTitle}
        </Heading>
        {loading ? <Stack direction='row' spacing='4'><Spinner mt='20' thickness="2px" speed="0.65s" emptyColor="gray.200" color="blue.500" size='xl' /></Stack> : error ? (
            <Alert status="error">
                <AlertIcon />
            ...
            <>
                ...
                {blogPosts.map((post)=> (
                    <Box key={post._id} maxW={{base: '3xl', lg: '2xl'}} px={{base:'6', md: '8', lg: '20'}}>
                        <Stack direction={{base: 'column', lg: 'row'}} spacing='7'>
                            <Image src={post.image} minW={{lg: '400px'}} maxH='200px' loading={<Spinner />} fit='cover' />
                            <Flex direction='column'>
                                ...
                                <Flex width='full' py='2'>
                                    ...
                                    <Text>
                                        ...
                                        <Spacer />
                                        <Link as={ReactLink} to={`/${post._id}`}>Read more...</Link>
